...
- [Coin Manager](https://github.com/imlystyi/coin-manager) - open-source application for Windows that allows you to track and manage the cryptocurrency market
- [QuickPlans](https://github.com/imlystyi/quickplans) - simple, quick and concise open-source note editor for Android
- [ilt](https://github.com/imlystyi/ilt) - open-source application that help you quickly insert license text (header) into your source code files
